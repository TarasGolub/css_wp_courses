...
//                    setlocale( LC_ALL , " ru_RU ");
                $name = trim($_GET['input_name']);
                $email = trim($_GET['input_email']);
                $facebook = trim($_GET['input_facebook']);
                $subject = trim($_GET['input_subject']);
                $message = trim($_GET['input_message']);
                $nameDuble = $name;
...
//                    }
            ...
            <p>
                ...
                Ваш email: <span class="user_data"><a href="mailto:<?php echo $email?>?subject=<?php echo $subject?>">
