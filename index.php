...
<main class="main_page ">
    <div class="row">
        <article class="post text_post col">
            <div class="article_content_wrap">
                ...
                <div class="post_content top_line">
                    <p>
                        ...
                        debitis eos excepturi, nemo nisi nobis, officia, sint tenetur vel veritatis vitae? Adipisci consequatur
                        dignissimos ex quia sed.
                    </p>
                </div>
            </div>
            <footer class="post_footer">
                ...
                <div class="hash_tag_container">
                    <span class="hash_tag_item"><a href="#">#Yosemite</a></span>
                    <span class="hash_tag_item"><a href="#">#Peak</a></span>
                    <span class="hash_tag_item"><a href="#">#Explorer</a></span>
                </div>
            </footer>
        </article>
        ...
        <article class="post image_post col">
            <figure class="post_image single_image">
                <img src="public/images/img_1.jpg" alt="image mountains " title="Mountains">
                <div class="pin_it">
                    <a href="http://pinterest.com"><img src="public/images/pin_it.png" alt="pin_it"></a>
                </div>
            </figure>
            <div class="article_content_wrap">
                <div class="i_do">
                ...
                <div class="post_content top_line">
                    ...
                    <p>
                        ...
                        error exercitationem fugiat in, officiis quae vel. Aspernatur commodi fugit incidunt iste neque odit
                        provident rerum tempora? amet, consectetur adipisicing elit. Assumenda consequuntur dicta distinctio
                        dolorum error exercitationem fugiat in, officiis elit. Assumenda consequuntur dicta distinctio
                        dolorum error exercitationem fugiat in, officiis
                    </p>
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda consequuntur dicta distinctio dolorum
                        error exercitationem fugiat in, officiis quae vel. Aspernatur commodi fugit incidunt iste neque odit
                        provident rerum tempora?
                    </p>
                </div>
            </div>
            <footer class="post_footer">
                ...
                <div class="hash_tag_container">
                    <span class="hash_tag_item"><a href="#">#Yosemite</a></span>
                    <span class="hash_tag_item"><a href="#">#Peak</a></span>
                    <span class="hash_tag_item"><a href="#">#Photo</a></span>
                </div>
            </footer>
        </article>
        ...
        <article class="post gallery_post col">
            <figure class="post_image gallery_image">
                <img src="public/images/img_2.jpg" alt="gallery" title="gallery" class="no_padd">
            ...
            <footer class="post_footer">
                ...
                <div class="hash_tag_container">
                    <span class="hash_tag_item"><a href="#">#Yosemite</a></span>
                    <span class="hash_tag_item"><a href="#">#Photo</a></span>
                    <span class="hash_tag_item"><a href="#">#Hi-res</a></span>
                </div>
            </footer>
        </article>

        <article class="post video_post col">
            <figure class="post_image">
                <img src="public/images/img_3.jpg" alt="video" title="video" class="no_padd">
            </figure>
            <div class="article_content_wrap">
                <div class="i_do">
                    <a href="#">I do watch</a>
...
<!--                    </div>-->
            ...
            <footer class="post_footer">
                <div class="hash_tag_container video_hash_tag_container">
                    <span class="hash_tag_item"><a href="#">#Yosemite</a></span>
                    <span class="hash_tag_item"><a href="#">#Peak</a></span>
                    <span class="hash_tag_item"><a href="#">#Photo</a></span>
                </div>
        ...
        <article class="post quote_post col">
            <div class="article_content_wrap">
<!--                    <header class="post_header">-->
                <div class="i_do">
                    <a href="#">I do quote</a>
...
<!--                    </header>-->
            ...
            <footer class="post_footer">
                <div class="hash_tag_container quote_author">
                    <span>— Lorraine Hansberry</span>
                </div>
            </footer>
        </article>

        <article class="post audio_post col">
            <figure class="post_image">
                <img src="public/images/img_4.jpg" alt="audio" title="audio" class="no_padd">
            </figure>
            <div class="article_content_wrap audio_article_content_wrap">
                <div class="i_do">
            ...
            <footer class="post_footer">
                ...
                <div class="hash_tag_container">
                    <span class="hash_tag_item"><a href="#">#Weekend</a></span>
                    <span class="hash_tag_item"><a href="#">#Music</a></span>
                    <span class="hash_tag_item"><a href="#">#Discovery</a></span>
                </div>
            </footer>
        </article>
...
<!--                </div>-->
            ...
            <footer class="post_footer">
                ...
                <div class="hash_tag_container">
                    <span class="hash_tag_item"><a href="#">#Idea</a></span>
                    <span class="hash_tag_item"><a href="#">#Yosemite</a></span>
                    <span class="hash_tag_item"><a href="#">#Vacation</a></span>
                </div>
            </footer>
        </article>

        <article class="post article_post col">
            <div class="article_content_wrap">
                <div class="i_do">
                ...
                <div class="post_content top_line">
                    ...
                    <p>
                        ...
                        aliquam architecto corporis in.
                    </p>
                    <blockquote class="sculpture_quote">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. A accusamus alias aperiam at atque cum
                            cumque cupiditate ea, error eum explicabo id molestias perferendis quae, sequi sit tempore,
                            veritatis voluptatem?
                    </blockquote>
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium, aliquid consequatur dolorem
                        eaque eveniet, explicabo facere incidunt maxime mollitia necessitatibus nostrum officiis porro sint
            ...
            <footer class="post_footer">
                ...
                <div class="hash_tag_container">
                    <span class="hash_tag_item"><a href="#">#Democracy</a></span>
                    <span class="hash_tag_item"><a href="#">#Introspection</a></span>
                </div>
            </footer>
        </article>
