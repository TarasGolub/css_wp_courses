    ...
    <main class="main_page">
        <article class="post text_post">
            ...
            <footer class="post_footer">
                ...
                <div class="hash_tag_container">
                    <span class="hash_tag_item">Yosemite</span>
                    <span class="hash_tag_item">Peak</span>
                    <span class="hash_tag_item">Explorer</span>
                </div>
            </footer>
        </article>
        ...
        <article class="post image_post">
            ...
            <footer class="post_footer">
                ...
                <div class="hash_tag_container">
                    <span class="hash_tag_item">Yosemite</span>
                    <span class="hash_tag_item">Peak</span>
                    <span class="hash_tag_item">Photo</span>
                </div>
            </footer>
        </article>
        ...
        <article class="post gallery_post">
            ...
            <footer class="post_footer">
                ...
                <div class="hash_tag_container">
                    <span class="hash_tag_item">Yosemite</span>
                    <span class="hash_tag_item">Photo</span>
                    <span class="hash_tag_item">Hi-res</span>
                </div>
            </footer>
        </article>
        ...
        <article class="post audio_post">
            ...
            <footer class="post_footer">
                ...
                <div class="hash_tag_container">
                    <span class="hash_tag_item">Weekend</span>
                    <span class="hash_tag_item">Music</span>
                    <span class="hash_tag_item">Discovery</span>
                </div>
            </footer>
        </article>
        ...
        <article class="post slider_post">
            ...
            <footer class="post_footer">
                ...
                <div class="hash_tag_container">
                    <span class="hash_tag_item">Idea</span>
                    <span class="hash_tag_item">Yosemite</span>
                    <span class="hash_tag_item">Vacation</span>
                </div>
            </footer>
        </article>

        <article class="post article_post">
            <header class="post_header">
                <div class="post_date">
                    Sep 11
                </div>
            ...
            <footer class="post_footer">
                ...
                <div class="hash_tag_container">
                    <span class="hash_tag_item">Democracy</span>
                    <span class="hash_tag_item">Introspection</span>
                </div>
            </footer>
        </article>
    </main>
